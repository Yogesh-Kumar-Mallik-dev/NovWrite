...
export default function WorldStudioScreen() {
  ...
  const [ruleFormSeverity, setRuleFormSeverity] = useState<RuleSeverity>("BLOCKING_ERROR");
  const [ruleFormType, setRuleFormType] = useState<RuleType>("STATE_GUARD");
  const [ruleFormPredicate, setRuleFormPredicate] = useState("");
  ...
  function handleSaveEntity() {
    ...
    if (editingEntityId) {
      mobileStore.updateEntity(editingEntityId, {
  ...
  function handleSaveBlueprint() {
    if (!bpFormName.trim()) return;
    if (editingBlueprintId) {
      mobileStore.updateBlueprint(editingBlueprintId, {
        name: bpFormName.trim(),
  ...
  function openCreateEvent() {
    ...
    setEventFormTitle("");
    const lastNSeq = sortedTimelineEvents[sortedTimelineEvents.length - 1]?.narrativeSequenceNumber || 0;
    const lastCOrd = sortedTimelineEvents[sortedTimelineEvents.length - 1]?.chronologicalOrder || 0;
  ...
  function handleSaveEvent() {
    ...
    const nSeq = parseInt(eventFormNarrativeSeq, 10) || 10;
    const cOrd = parseInt(eventFormChronoOrder, 10) || 10;

    if (editingEventId) {
      mobileStore.updateTimelineEvent(editingEventId, {
  ...
  function openCreateRule() {
    ...
    setRuleFormName("");
    setRuleFormSeverity("BLOCKING_ERROR");
    setRuleFormType("STATE_GUARD");
    setRuleFormPredicate("");
  ...
  function openEditRule(r: InvariantRuleItem) {
    ...
    setRuleFormType(r.type);
    setRuleFormPredicate(r.predicateExpression);
    setRuleFormDescription(r.description);
    setIsRuleModalOpen(true);
  }
  ...
  function handleSaveRule() {
    ...
    if (editingRuleId) {
      mobileStore.updateRule(editingRuleId, {
        name: ruleFormName.trim(),
        severity: ruleFormSeverity,
        type: ruleFormType,
        predicateExpression: ruleFormPredicate.trim(),
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#09090b" }}>
        ...
        <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.8)", justifyContent: "center", alignItems: "center", padding: 16 }}>
          <View style={{ backgroundColor: "#121215", borderColor: "#27272a", borderWidth: 1, borderRadius: 14, padding: 18, width: "100%", maxWidth: 450, maxHeight: "90%", gap: 12 }}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "flex-end", gap: 8, marginTop: 6 }}>
              <TouchableOpacity
                onPress={() => setIsEntityModalOpen(false)}
              ...
              >
                <Text style={{ color: "#ffffff", fontSize: 13, fontWeight: "bold" }}>Save Entity</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
      ...
      <Modal visible={isBlueprintModalOpen} transparent animationType="fade">
        <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.8)", justifyContent: "center", alignItems: "center", padding: 16 }}>
          <View style={{ backgroundColor: "#121215", borderColor: "#27272a", borderWidth: 1, borderRadius: 14, padding: 18, width: "100%", maxWidth: 450, maxHeight: "90%", gap: 12 }}>
            ...
            <ScrollView style={{ maxHeight: 380 }} contentContainerStyle={{ gap: 10 }}>
              <View style={{ gap: 4 }}>
                <Text style={{ color: "#a1a1aa", fontSize: 12 }}>Blueprint Name *</Text>
                <TextInput
                  value={bpFormName}
                  onChangeText={setBpFormName}
                  placeholder="e.g. Cultivator Archetype"
                  placeholderTextColor="#71717a"
                  style={{ backgroundColor: "#18181b", borderColor: "#27272a", borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, color: "#fafafa", fontSize: 13, minHeight: 44 }}
                />
              </View>
              ...
              <View style={{ gap: 4 }}>
                <Text style={{ color: "#a1a1aa", fontSize: 12 }}>Blueprint Class</Text>
                <View style={{ flexDirection: "row", gap: 6 }}>
                  <TouchableOpacity
                    onPress={() => setBpFormClass("FIRST_CLASS")}
                    style={{
                      flex: 1,
                      paddingVertical: 8,
                      borderRadius: 6,
                      backgroundColor: bpFormClass === "FIRST_CLASS" ? "rgba(124, 58, 237, 0.2)" : "#18181b",
                      borderColor: bpFormClass === "FIRST_CLASS" ? "#7c3aed" : "#27272a",
                      borderWidth: 1,
                      alignItems: "center",
                      minHeight: 36,
                      justifyContent: "center",
                  ...
                  >
                    <Text style={{ color: bpFormClass === "FIRST_CLASS" ? "#7c3aed" : "#a1a1aa", fontSize: 11, fontWeight: "bold" }}>1st-Class Archetype</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    onPress={() => setBpFormClass("SECOND_CLASS")}
                    style={{
                      flex: 1,
                      paddingVertical: 8,
                      borderRadius: 6,
                      backgroundColor: bpFormClass === "SECOND_CLASS" ? "rgba(56, 189, 248, 0.2)" : "#18181b",
                      borderColor: bpFormClass === "SECOND_CLASS" ? "#38bdf8" : "#27272a",
                      borderWidth: 1,
                      alignItems: "center",
                      minHeight: 36,
                      justifyContent: "center",
                  ...
                  >
                    <Text style={{ color: bpFormClass === "SECOND_CLASS" ? "#38bdf8" : "#a1a1aa", fontSize: 11, fontWeight: "bold" }}>2nd-Class Sub-Schema</Text>
                  </TouchableOpacity>
                </View>
              </View>
              ...
              <View style={{ gap: 4 }}>
                ...
                <TextInput
                  ...
                  onChangeText={setBpFormCategory}
                  placeholder="e.g. Characters / Artifacts / Relics"
                  placeholderTextColor="#71717a"
                  style={{ backgroundColor: "#18181b", borderColor: "#27272a", borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, color: "#fafafa", fontSize: 13, minHeight: 44 }}
                />
              </View>
              ...
              <View style={{ gap: 4 }}>
                ...
                <TextInput
                  ...
                  onChangeText={setBpFormDescription}
                  placeholder="Schema archetype purpose..."
                  placeholderTextColor="#71717a"
                  multiline
                  numberOfLines={3}
                  style={{ backgroundColor: "#18181b", borderColor: "#27272a", borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, color: "#fafafa", fontSize: 13, minHeight: 60, textAlignVertical: "top" }}
            ...
            <View style={{ flexDirection: "row", justifyContent: "flex-end", gap: 8, marginTop: 6 }}>
              <TouchableOpacity
                onPress={() => setIsBlueprintModalOpen(false)}
                style={{ paddingHorizontal: 14, paddingVertical: 10, borderRadius: 8, backgroundColor: "#18181b", minHeight: 44, justifyContent: "center" }}
              >
                <Text style={{ color: "#a1a1aa", fontSize: 13, fontWeight: "600" }}>Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity
                ...
                style={{ paddingHorizontal: 16, paddingVertical: 10, borderRadius: 8, backgroundColor: "#7c3aed", minHeight: 44, justifyContent: "center" }}
              >
                <Text style={{ color: "#ffffff", fontSize: 13, fontWeight: "bold" }}>Save Schema</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
      ...
      <Modal visible={isEventModalOpen} transparent animationType="fade">
        <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.8)", justifyContent: "center", alignItems: "center", padding: 16 }}>
          <View style={{ backgroundColor: "#121215", borderColor: "#27272a", borderWidth: 1, borderRadius: 14, padding: 18, width: "100%", maxWidth: 450, maxHeight: "90%", gap: 12 }}>
            ...
            <ScrollView style={{ maxHeight: 380 }} contentContainerStyle={{ gap: 10 }}>
              <View style={{ gap: 4 }}>
                <Text style={{ color: "#a1a1aa", fontSize: 12 }}>Event Title *</Text>
                <TextInput
                  value={eventFormTitle}
                  onChangeText={setEventFormTitle}
                  placeholder="e.g. Discovery of the Ancient Scripture"
                  placeholderTextColor="#71717a"
                  style={{ backgroundColor: "#18181b", borderColor: "#27272a", borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, color: "#fafafa", fontSize: 13, minHeight: 44 }}
                />
              </View>
              ...
              <View style={{ flexDirection: "row", gap: 8 }}>
                <View style={{ flex: 1, gap: 4 }}>
                  <Text style={{ color: "#a1a1aa", fontSize: 12 }}>Narrative Seq #</Text>
                  <TextInput
                    value={eventFormNarrativeSeq}
                    onChangeText={setEventFormNarrativeSeq}
                ...
                <View style={{ flex: 1, gap: 4 }}>
                  <Text style={{ color: "#a1a1aa", fontSize: 12 }}>Chrono Order #</Text>
                  <TextInput
                    value={eventFormChronoOrder}
                    onChangeText={setEventFormChronoOrder}
                    keyboardType="numeric"
                    placeholder="100"
                    placeholderTextColor="#71717a"
                    style={{ backgroundColor: "#18181b", borderColor: "#27272a", borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, color: "#fafafa", fontSize: 13, minHeight: 44 }}
            ...
            <View style={{ flexDirection: "row", justifyContent: "flex-end", gap: 8, marginTop: 6 }}>
              ...
              <TouchableOpacity
                ...
                style={{ paddingHorizontal: 16, paddingVertical: 10, borderRadius: 8, backgroundColor: "#7c3aed", minHeight: 44, justifyContent: "center" }}
              >
                <Text style={{ color: "#ffffff", fontSize: 13, fontWeight: "bold" }}>Save Event</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
      ...
      {/* Rule Modal */}
      <Modal visible={isRuleModalOpen} transparent animationType="fade">
        <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.8)", justifyContent: "center", alignItems: "center", padding: 16 }}>
          <View style={{ backgroundColor: "#121215", borderColor: "#27272a", borderWidth: 1, borderRadius: 14, padding: 18, width: "100%", maxWidth: 450, maxHeight: "90%", gap: 12 }}>
            <Text style={{ color: "#fafafa", fontSize: 17, fontWeight: "bold" }}>
              {editingRuleId ? "Edit Invariant Rule" : "Define Invariant Rule"}
            </Text>
            <ScrollView style={{ maxHeight: 380 }} contentContainerStyle={{ gap: 10 }}>
              <View style={{ gap: 4 }}>
                <Text style={{ color: "#a1a1aa", fontSize: 12 }}>Rule Name *</Text>
                <TextInput
                  value={ruleFormName}
                  onChangeText={setRuleFormName}
                  placeholder="e.g. Mortally Wounded Characters Cannot Battle"
                  placeholderTextColor="#71717a"
                  style={{ backgroundColor: "#18181b", borderColor: "#27272a", borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, color: "#fafafa", fontSize: 13, minHeight: 44 }}
                />
              </View>
              ...
              <View style={{ gap: 4 }}>
                <Text style={{ color: "#a1a1aa", fontSize: 12 }}>Severity</Text>
                <View style={{ flexDirection: "row", gap: 6 }}>
                  {(["BLOCKING_ERROR", "WARNING", "ADVISORY_NOTE"] as RuleSeverity[]).map((sev) => (
                    <TouchableOpacity
                      key={sev}
                      onPress={() => setRuleFormSeverity(sev)}
                      style={{
                        flex: 1,
                        paddingVertical: 8,
                        borderRadius: 6,
                        backgroundColor: ruleFormSeverity === sev ? "rgba(124, 58, 237, 0.2)" : "#18181b",
                        borderColor: ruleFormSeverity === sev ? "#7c3aed" : "#27272a",
                        borderWidth: 1,
                        alignItems: "center",
                        minHeight: 36,
                        justifyContent: "center",
                    ...
                    >
                      <Text style={{ color: ruleFormSeverity === sev ? "#7c3aed" : "#a1a1aa", fontSize: 10, fontWeight: "bold" }}>
                        {sev === "BLOCKING_ERROR" ? "BLOCKING" : sev === "WARNING" ? "WARN" : "NOTE"}
                      </Text>
                    </TouchableOpacity>
                  ))}
                </View>
              ...
              <View style={{ gap: 4 }}>
                <Text style={{ color: "#a1a1aa", fontSize: 12 }}>Predicate Expression</Text>
                <TextInput
                  value={ruleFormPredicate}
                  onChangeText={setRuleFormPredicate}
                  placeholder="e.g. entity.status != 'DEAD'"
                  placeholderTextColor="#71717a"
                  style={{ backgroundColor: "#18181b", borderColor: "#27272a", borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, color: "#fafafa", fontSize: 13, minHeight: 44, fontFamily: "monospace" }}
                />
              </View>
              ...
              <View style={{ gap: 4 }}>
                ...
                <TextInput
                  ...
                  onChangeText={setRuleFormDescription}
                  placeholder="Why this invariant exists and how to resolve violations..."
                  placeholderTextColor="#71717a"
                  multiline
                  numberOfLines={3}
                  style={{ backgroundColor: "#18181b", borderColor: "#27272a", borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, color: "#fafafa", fontSize: 13, minHeight: 60, textAlignVertical: "top" }}
            ...
            <View style={{ flexDirection: "row", justifyContent: "flex-end", gap: 8, marginTop: 6 }}>
              ...
              <TouchableOpacity
                ...
                style={{ paddingHorizontal: 16, paddingVertical: 10, borderRadius: 8, backgroundColor: "#7c3aed", minHeight: 44, justifyContent: "center" }}
              >
                <Text style={{ color: "#ffffff", fontSize: 13, fontWeight: "bold" }}>Save Rule</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
