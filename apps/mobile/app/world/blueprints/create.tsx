...
export default function CreateBlueprintScreen() {
  ...
  const [blueprintClass, setBlueprintClass] =
    useState<BlueprintClass>("FIRST_CLASS");
  ...
  const [fields, setFields] = useState<DynamicFieldDef[]>([
    {
      ...
      fieldType: "STRING",
      required: true,
      description: "Canonical identity name",
    },
  ]);
  const [error, setError] = useState<string | null>(null);

  const existingBlueprints = mobileStore.getBlueprints();
        ...
        >
          ...
          <View className="mb-5">
            ...
            <TextInput
              ...
              placeholder="e.g. Cultivator Archetype, Sacred Armament, Spirit Beast"
            ...
            <View className="flex-row gap-3">
              ...
              >
                ...
                <Text className="mt-1 text-[11px] leading-4 text-zinc-400">
                  Primary world entity with direct timeline mutation tracking
                  and canonical state.
                </Text>
              </TouchableOpacity>
              ...
              >
                ...
                <Text className="mt-1 text-[11px] leading-4 text-zinc-400">
                  Nested value object / component embedded inside parent entity
                  properties.
                </Text>
              </TouchableOpacity>
            </View>
          ...
          <View className="mb-5">
            ...
            <View className="flex-row flex-wrap gap-2">
              ...
              >
                <Text
                  className={`text-xs font-medium ${
                    isCustomCategory ? "text-amber-400" : "text-zinc-400"
                  }`}
                >
                  Custom Category...
                </Text>
          ...
          <View className="mb-6">
            <Text className="mb-2 text-xs font-semibold uppercase tracking-wider text-zinc-300">
              Blueprint Lore Description & Contract
            </Text>
            <TextInput
              value={description}
              onChangeText={setDescription}
              placeholder="Describe what entities derived from this blueprint represent in your universe..."
              placeholderTextColor="#71717a"
              multiline
              numberOfLines={3}
              ...
              {fields.map((field, idx) => (
                ...
                >
                  ...
                  <View className="mb-3 flex-row gap-2">
                    <View className="flex-1">
                      ...
                      <TextInput
                        ...
                        placeholder="e.g. Base Qi, Cultivation Realm"
                        placeholderTextColor="#71717a"
                  ...
                  {field.fieldType === "FORMULA" && (
                    <View className="mb-3 rounded-lg border border-violet-500/30 bg-violet-950/20 p-3">
                      ...
                      <TextInput
                        ...
                        placeholder="e.g. (base_qi + gear_bonus) * multiplier + 50"
                        placeholderTextColor="#71717a"
                  ...
                  {(field.fieldType === "ENUM" ||
                    ...
                    <View className="mb-3 rounded-lg border border-zinc-800 bg-zinc-950 p-3">
                      <Text className="mb-1.5 text-[11px] font-semibold text-zinc-300">
                        Discrete Options (Comma-separated or with :power)
                      </Text>
                      <TextInput
                        value={
                        ...
                        placeholder="e.g. Qi Refining:100, Foundation:500, Core Formation:2500"
                        placeholderTextColor="#71717a"
                  ...
                  {field.fieldType === "NUMBER" && (
                    <View className="mb-3 flex-row gap-2">
                      <View className="flex-1">
                        <Text className="mb-1 text-[10px] text-zinc-400">
                          Min Bound
                        </Text>
                        <TextInput
                          value={
                          ...
                          onChangeText={(t) =>
                            updateField(idx, {
                              min: t === "" ? undefined : Number(t),
                            })
                          }
                          keyboardType="numeric"
                          placeholder="0"
                          placeholderTextColor="#71717a"
                          className="rounded border border-zinc-800 bg-zinc-950 px-2 py-1.5 text-xs text-zinc-100"
                        />
                      </View>
                      <View className="flex-1">
                        <Text className="mb-1 text-[10px] text-zinc-400">
                      ...
                      <View className="flex-1">
                        ...
                        <TextInput
                          ...
                          onChangeText={(t) =>
                            updateField(idx, {
                              defaultValue: t === "" ? undefined : Number(t),
                            })
                          }
                          keyboardType="numeric"
                          placeholder="100"
