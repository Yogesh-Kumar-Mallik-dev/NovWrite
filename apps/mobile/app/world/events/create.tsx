...
export default function CreateTimelineEventScreen() {
        ...
        <View className="flex-row items-center justify-between border-b border-zinc-800 bg-zinc-900/90 px-4 py-3.5">
          ...
          <View className="flex-1 items-center px-3">
            ...
            <Text className="text-xs text-zinc-400">
              Causal State Mutation & Lore Milestone
            </Text>
          </View>
          <TouchableOpacity
            onPress={handleSave}
        ...
        >
          ...
          <View className="mb-5">
            ...
            <TextInput
              ...
              placeholder="e.g. Discovery of Spirit Spring, Fall of Heavenly Sect"
