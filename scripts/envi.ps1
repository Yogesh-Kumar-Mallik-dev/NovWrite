...
Write-Host "========================================================" -ForegroundColor Green
Write-Host "  -> Start Development Servers:  .\dev.ps1"
Write-Host "  -> Run Full Test Suite:        .\test.ps1"
Write-Host "  -> Run Typechecks:             .\check.ps1"
Write-Host "  -> Teardown / Reset:           .\uenvi.ps1"
Write-Host "========================================================" -ForegroundColor Green
Write-Host ""
