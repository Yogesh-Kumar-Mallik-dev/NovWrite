  ...
  return (
    ...
    >
      <motion.a
        ...
        className="inline-flex font-bold h-11 select-none items-center justify-center rounded-full bg-primary px-6 text-sm text-primary-foreground transition-colors hover:bg-primary/90"
      >
        {homeLabel}
      </motion.a>
      <motion.a
        ...
        whileHover={whileHover}
        transition={SPRING_PRESS}
        className="inline-flex h-11 select-none items-center justify-center rounded-full border border-border bg-card px-6 text-sm font-bold text-foreground transition-colors hover:bg-primary/5"
      >
        {browseLabel}
      </motion.a>
    </div>
