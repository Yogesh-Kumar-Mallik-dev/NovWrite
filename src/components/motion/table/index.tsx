...
import { ScrollIndicator } from "@/components/motion/scrollbar";
import { useElementScroll } from "@/components/motion/use-element-scroll";
...
export function Table<T>({
  ...
  const { progress, thumbSize } = useElementScroll(scrollRef);
  return (
    <div
      className={cn(
