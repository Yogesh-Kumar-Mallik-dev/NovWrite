    ...
    <>
      ...
      <thead>
        <tr style={{ height: rowHeight }}>
          {selectable ? (
            <th className="sticky top-0 z-10 border-border border-b bg-primary/15 backdrop-blur-sm">
          ...
          {columns.map((column, index) => {
            ...
            return (
              <th
                ...
                className={cn(
                  "group sticky top-0 z-10 border-border border-b bg-primary/15 p-0 font-semibold text-black dark:text-white backdrop-blur-sm",
                  "data-[drop=true]:before:absolute data-[drop=true]:before:inset-y-0 data-[drop=true]:before:left-0 data-[drop=true]:before:w-0.5 data-[drop=true]:before:bg-primary-foreground",
                  "data-[dropend=true]:after:absolute data-[dropend=true]:after:inset-y-0 data-[dropend=true]:after:right-0 data-[dropend=true]:after:w-0.5 data-[dropend=true]:after:bg-primary-foreground",
                )}
              >
                <motion.div
                ...
                >
                  {reorderable ? (
                    <button
                      ...
                      className="flex h-full cursor-grab touch-none items-center pl-2 text-primary/35 transition-colors hover:text-primary/70 active:cursor-grabbing"
                    >
                  ...
                  {column.sortable ? (
                    <button
                      ...
                      className={cn(
                        "flex h-full min-w-0 flex-1 select-none items-center gap-1 px-4 transition-colors hover:text-black dark:hover:text-white",
                    ...
                    <input
                      ...
                      className={cn(
                        "min-w-0 flex-1 truncate appearance-none rounded-md border-0 bg-transparent px-4 font-medium text-black dark:text-white outline-none transition-colors focus:bg-primary/25",
          ...
          <th
            aria-hidden
            className="sticky top-0 z-10 border-border border-b bg-primary/15 backdrop-blur-sm"
          />
        </tr>
      </thead >
    </>
